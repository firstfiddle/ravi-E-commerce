              ...
              <div className="d-inline-flex align-items-center ">
                {
                  user ? (
                    <div className="btn-group">
                      <button type="button"  className="btn btn-sm btn-warning dropdown-toggle" data-bs-toggle="dropdown">{user && user.name}</button>
                  ...
                  ) : !loading && <Link className="dropdown-item" to='/login'> 
